...
function permissio(id){
	 var url = "${pageContext.servletContext.contextPath }/background/resources/permissioUser.do?userId="+id;
	 var h_sp1 = 400;
	 var w_sp1 = 350;
...
function userRole(id){
	 var url = "${pageContext.servletContext.contextPath }/background/user/userRole.do?userId="+id;
	 var h_sp1 = 420;
	 var w_sp1 = 600;
	//兼容IE，firefox,google.模态窗口居中问题
	 var iTop2 = (window.screen.availHeight - 20 - h_sp1) / 2;
...
<body>
<form id="fenye" name="fenye" action="${pageContext.servletContext.contextPath }/background/user/query.do" method="post">
<table width="100%">
  <tr>
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          ...
          <tr>
            ...
            <td height="20" ><span class="STYLE1"><a href="${pageContext.servletContext.contextPath }/background/user/getById.do?userId=${key.userId}&&type=0">${key.userName}</a></span></td>
            ...
            <a href="${pageContext.servletContext.contextPath }/background/user/getById.do?userId=${key.userId}&&type=1">
                                     编辑
            </a>
            &nbsp; &nbsp;
           </sec:authorize>
           <sec:authorize ifAnyGranted="ROLE_sys_user_delete">
            <img src="${pageContext.servletContext.contextPath }/images/del.gif" width="16" height="16" />
            	<a href="javascript:void(0);" onclick="deleteId('${pageContext.servletContext.contextPath }/background/user/deleteById.do?userId=${key.userId}');">
            	删除</a>
            	</sec:authorize>
            	</span></td>
          </tr>
