...
function permissio(id){
	 var url = "${pageContext.servletContext.contextPath }/background/resources/permissioRole.do?roleId="+id;
	 var h_sp1 = 400;
	 var w_sp1 = 350;
...
<body>
<form id="fenye" name="fenye" action="${pageContext.servletContext.contextPath }/background/role/query.do" method="post">
<table width="100%">
  <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          ...
          <tr>
            ...
            <img src="${pageContext.servletContext.contextPath }/images/del.gif" width="16" height="16" />
            	<a href="${pageContext.servletContext.contextPath }/background/role/getById.do?roleId=${role.id}&&typeKey=0">
            	显示详细信息</a>
            	&nbsp;&nbsp;</sec:authorize>
            ...
            <a href="${pageContext.servletContext.contextPath }/background/role/getById.do?roleId=${role.id}&&typeKey=1">
                                     编辑
            </a>
            &nbsp; &nbsp;</sec:authorize>
            <sec:authorize ifAnyGranted="ROLE_sys_role_delete">
            <img src="${pageContext.servletContext.contextPath }/images/del.gif" width="16" height="16" />
            	<a href="javascript:void(0);" onclick="deleteId('${pageContext.servletContext.contextPath }/background/role/deleteById.do?roleId=${role.id}')">
            	删除</a>
            	</sec:authorize>
            	</span></td>
          </tr>
