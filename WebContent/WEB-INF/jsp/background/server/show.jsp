...
<script type="text/javascript">
	...
	function loadTabData() {
		$.ajax({
					type : 'POST',
					url : "${pageContext.request.contextPath}/background/serverInfo/info.do",
					dataType : 'json',
					success : function(json) {
						...
						var sun=$("#jvmTotalMem").do()-$("#jvmFreeMem").do();
						fchart("JVM","M", "剩余容量", $("#jvmFreeMem").do(), "已经使用", sun, "JVM", "jvmchart");
						...
						$("#memPercent").do(memPercent);
						$("#swapPercent").do(swapPercent);
