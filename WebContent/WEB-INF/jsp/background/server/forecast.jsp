...
$(function(){
	$(".loading").showLoading(); 
	var url = "${pageContext.request.contextPath}/background/serverInfo/warnInfo.do";
	$.ajax({
		type : 'POST',
		url : url,
		dataType : 'json',
...
function modifySer(key){
	$.ajax({
        async: false,
        url: "${pageContext.request.contextPath}/background/serverInfo/modifySer.do",
