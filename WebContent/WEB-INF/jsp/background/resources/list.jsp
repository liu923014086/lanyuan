...
<body>
<form id="fenye" name="fenye" action="${pageContext.servletContext.contextPath }/background/resources/query.do" method="post">
<table width="100%">
  <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          ...
          <tr>
            ...
            <img src="${pageContext.servletContext.contextPath }/images/del.gif" width="16" height="16" />
            	<a href="${pageContext.servletContext.contextPath }/background/resources/getById.do?resourcesId=${resources.id}&&typeKey=0">
            	显示详细信息</a>
            	&nbsp;&nbsp;
				</sec:authorize>
            ...
            <a href="${pageContext.servletContext.contextPath }/background/resources/getById.do?resourcesId=${resources.id}&&typeKey=1">
                                     编辑
            </a>
            &nbsp; &nbsp;
            </sec:authorize>
            ...
            <img src="${pageContext.servletContext.contextPath }/images/del.gif" width="16" height="16" />
            	<a href="javascript:void(0);" onclick="deleteId('${pageContext.servletContext.contextPath }/background/resources/deleteById.do?resourcesId=${resources.id}')">
            	删除</a></sec:authorize>
            	</span></td>
          </tr>
          </c:forEach>
